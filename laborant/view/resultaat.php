                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table" id="myTable">
                      ...
                      <tbody>
                      <?php
                      $sql = "SELECT * FROM `resultaat` LEFT JOIN patient ON resultaat.id_patient = patient.id_patient LEFT JOIN triage ON resultaat.triagenummer = triage.triagenummer WHERE resultaat.id_gebruikers = '".$_SESSION['id']."' AND id_district = '".$_SESSION['district']."' ";
