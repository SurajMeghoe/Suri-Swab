<div class="modal fade" id="edituser<?php echo $row['id_gebruiker']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
				...
				<form method="POST" action="../../admin/backend/edit_user.php?id=<?php echo $erow['id_gebruiker']; ?>" method="POST">
				<div class="row">   
          <div class="col-md-6">
            <label for="naam" class="form-label">Naam</label>
            <input type="text" class="form-control" name="naam" id="naam" value="<?php echo $erow['Unaam']; ?>" required>
          </div>
    <div class="col-md-6">
            <label for="voornaam" class="form-label">Voornaam</label>
            <input type="text" class="form-control" name="voornaam" id="voornaam" value="<?php echo $erow['Uvoornaam']; ?>" required>
          </div>
    </div> 
...
<div class="row">   
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="username" id="username" value="<?php echo $erow['usernaam']; ?>" required>
          </div>
          <div class="col-md-6">
          <label for="password" class="form-label">Password</label>
          <input type="text" class="form-control" name="password" id="password" minlength="6" value="<?php echo $erow['password']; ?>" required>
       </div>
    ...
    <div class="row">   
         ...
         <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" aria-label="Default select example" name="rol" id="rol"  value="<?php echo $erow['role']; ?>" required>
