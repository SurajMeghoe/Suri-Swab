...
<div class="row">   
         <div class="col-md-6">
          ...
          <input type="date" class="form-control" name="datum" id="datum" value="<?php echo $erow['datum']; ?>" required>
       </div>
         ...
         <div class="col-md-6">
          ...
          <textarea class="form" name="omscrhrijving" id="omscrhrijving"  required><?php echo $erow['omschrijving']; ?></textarea>
                ...
                <div class="modal-footer">
                   ...
                   <button type="submit" name="resultaat" class="btn btn-primary">Save Data</button>
				</form>
                </div>
